        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="" method="GET" class="row g-3 mb-4 no-print border p-2 rounded bg-light">
                    ...
                    <div class="col-auto d-flex align-items-center">
                        <label class="col-form-label me-2">Sampai:</label>
                ...
                <?php if (isset($_GET['filter']) && count($rows) > 0): ?>
                    <div class="alert alert-info">
                        Laporan Periode: <strong><?php echo date('d-m-Y', strtotime($start_date)) ?></strong> s/d <strong><?php echo date('d-m-Y', strtotime($end_date)) ?></strong>
                    </div>
                ...
                <?php else: ?>
                    <div class="text-center p-5 text-muted">
                        ...
                        <p>Silakan pilih tanggal "Dari" dan "Sampai" untuk melihat laporan.</p>
                    </div>
                <?php endif; ?>
