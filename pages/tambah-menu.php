...
if (isset($_POST['simpan'])) {
    ...
    $icon = $_POST['icon'];
    $orders = $_POST['orders'];
    $insert = mysqli_query($config, "INSERT INTO menus (name, icon, link, `orders`) VALUES 
...
if (isset($_POST['update'])) {
    ...
    $icon = $_POST['icon'];
    $orders = $_POST['orders'];
    $update = mysqli_query($config, "UPDATE menus SET `orders`='$orders', name='$name', icon='$icon',
